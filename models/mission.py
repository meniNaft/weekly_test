...
class Mission:
    def __init__(self, target_city: str,priority: int,assigned_pilot: str, assigned_aircraft: str, distance_by_km: int, weather_conditions: Weather_conditions_enum, pilot_skill: int, aircraft_speed_by_mk: int, fuel_capacity_by_km: int, mission_fit_score: float):
